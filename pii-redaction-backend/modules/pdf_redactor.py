...
# Takes PDF bytes + a list of 
# entities ({ type, start, end, text, ... }) and returns new redacted PDF bytes.
# Figures out a label like [EMAIL_1], [PHONE_2], a custom label,
#  or just a black box (depending on label_style)
# Draws a black rectangle (with padding) using PyMuPDF.
